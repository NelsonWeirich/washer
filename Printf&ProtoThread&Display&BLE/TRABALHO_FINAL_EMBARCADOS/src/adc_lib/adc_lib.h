...
#define SENSOR_NIVEL_PIN       //Definir o pino para entrar no ADC. (Verificar manula para ver quais pinos o adc tem acesso e a tensão maxima).
...
//Fazer essas funções.
void initSensor_NivelAgua(int Sensor);   //Inicializar tudo, mede e tals.
